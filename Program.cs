...
namespace linq
{
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            // IEnumerable<string> LFruits = from fruit in fruits where fruit[0] == 'L' select fruit; // 1st way of doing it
            // IEnumerable<string> LLFruits = fruits.Where(f => f[0] == 'L'); // 2nd way of doing it

            // foreach (string item in LLFruits)
            // {
            ...
            // List<string> namesDescending = names.OrderByDescending(i => i).ToList();

            // foreach (string name in namesDescending)
            // {
            ...
            // List<int> numbersAscending = numbers.OrderBy(x => x).ToList();
            ...
            // What is our most / least expensive product? ->
            ...
            // double mostExpensivePrice = prices.Max();
            // Console.WriteLine(mostExpensivePrice.ToString("C"));

            // double leastExpensivePrice = prices.Min();
            // Console.WriteLine(leastExpensivePrice.ToString("C"));
            ...
            */
            ...
            // foreach (var number in nonSquares)
            // {
